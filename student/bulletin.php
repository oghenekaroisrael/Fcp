          ...
          <div class="col-12">
            <div class="card card-chart">
              <div class="card-header ">
                <h2 class="card-title">My Bulletin</h2>
                  ...
                  <table class="table tablesorter " id="">
                    ...
                    $t4=4;
                      ...
                      for ($i=100; $i <= $lvl; $i+=100) { 
                        $bulletins = Database::getInstance()->select_from_where_no3_group("courses","bulletin",$bid,"department",$deptID,"level",$i,"bulletin","courseType","ASC");
                        foreach ($bulletins as $bulletin) {
                          ?>
                            <tr>
                              ...
                              <td class="text-center">
                                <?php echo $t1+=$tu1 = Database::getInstance()->sum_where4("unit","courses","courseType",1,"level",$i,"department",$deptID,"bulletin",$bid);?>
                              </td>
                              
                              <td class="text-center">
                              <?php echo $t2+=$tu2 = Database::getInstance()->sum_where4("unit","courses","courseType",2,"level",$i,"department",$deptID,"bulletin",$bid);?>
                              </td>
                              
                              <td class="text-center">
                              <?php echo $t3+=$tu3 = Database::getInstance()->sum_where4("unit","courses","courseType",3,"level",$i,"department",$deptID,"bulletin",$bid);?>
                              </td>
