...
if(!isset($_SESSION['userSession'])){
  ...
  if (isset($_POST['name']) && !empty($_POST['name']) && isset($_POST['level']) && !empty($_POST['level'])) {
    ...
    $studData = Database::getInstance()->select_outstandings();
  }
}
?>
<body class="">
          ...
          <div class="col-12">
            <div class="card card-chart">
              <div class="card-header ">
                <h2 class="card-title">Outstanding Search</h2>
                    ...
                    <?php 
                        foreach ($studData as $row) {
                          ...
                          <tr>
                            ...
                            <td class="text-center">
                            <?php echo $row['outstandings']; ?>
                            </td>
                            <td class="text-center">
                                <a href="outstanding.php?id=<?php echo $row['matNo']; ?>"><i class="fas fa-eye text-primary"></i></a>
                            </td>
                          </tr>
                        <?php } ?>
                    </tbody>
